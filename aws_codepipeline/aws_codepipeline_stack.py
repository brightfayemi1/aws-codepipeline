...
class AwsCodepipelineStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        git_input = pipelines.CodePipelineSource.connection(
            repo_string="brightfayemi1/aws-codepipeline",
            branch="main",
            connection_arn="arn:aws:codestar-connections:us-east-1:777833739537:connection/ff5daf42-59cd-4395-ad35-c92b0830f727"
        )
        ...
        deployment_wave.add_stage(DeployStage(
            self, 'DeployStage',
            env=(Environment(account='777833739537', region='us-east-1'))
        ))